 ...
 * @author kevin
 */
public final class formTurno extends BaseSingleView<Turno> {

    /**
     * Creates new form formTurno
     */
    public formTurno() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formTurno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
